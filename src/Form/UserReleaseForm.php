 ...
 */
class UserReleaseForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $storage_assignment = NULL): array {
    ...
    if ((int) $this->assignment->get('field_storage_user')->target_id !== (int) $this->storageCurrentUser->id()) {
    ...
    if ($this->assignment->get('field_storage_assignment_status')->value !== 'active') {
      $form['message'] = [
        '#type' => 'container',
    ...
    $unit = $this->assignment->get('field_storage_unit')->entity;
    ...
    $details = [
      ...
      $this->t('Start date: @date', ['@date' => $this->assignment->get('field_storage_start_date')->value ?: $this->t('Not recorded')]),
    ];
